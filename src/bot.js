...
if (message.content === '!help'){
    ...
    const embed = new MessageEmbed()
        ...
        .addFields(
            ...
            {name:'-----', value: '-----', inline: false},
            {name:'!rank', value: 'I will tell you the rank you have,\nbased on your activities in the server', inline: true},
            {name:'!lb/leaderboard', value: 'I will show you the leaderboard of the rank', inline: true},
